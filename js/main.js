jQuery(document).ready(function($){
	$(".cd-half-block .blog-site a").mouseenter(function() {
		$(".cd-section:nth-of-type(3) .cd-half-block:first-of-type").addClass("blog-thumbnail");
	}).mouseleave(function() {
		$(".cd-section:nth-of-type(3) .cd-half-block:first-of-type").removeClass("blog-thumbnail");
	});
